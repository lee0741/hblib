  ...
  $.ajax({
    url: isbnurl,
      ...
      if (msg.indexOf('检索不到记录!') != -1) {
        ...
        var bookrecno = $(msg).find('.expressServiceTab:first').attr('express_bookrecno');
        $.ajax({
          url: 'http://hbtinterlib.library.hb.cn/opac/book/holdingpreview/' + bookrecno,
          data: {},
          dataType: 'xml',
          success: function (xml) {
            ...
            function createTable(tableHeader, tableContent) {
              var s = '<table><tr>';
